...
public class JdbcBatchItemWriter<T> implements ItemWriter<T>, InitializingBean {
     ...
     * {@link org.springframework.batch.item.database.ItemPreparedStatementSetter}.
    ...
    /**
     * Public setter for the {@link org.springframework.batch.item.database.ItemPreparedStatementSetter}.
     * @param preparedStatementSetter the {@link org.springframework.batch.item.database.ItemPreparedStatementSetter} to
    ...
    /**
     * Public setter for the {@link org.springframework.batch.item.database.ItemSqlParameterSourceProvider}.
     * @param itemSqlParameterSourceProvider the {@link org.springframework.batch.item.database.ItemSqlParameterSourceProvider} to
     * set. This is required when using named parameters for the SQL statement and the type
     * to be written does not implement {@link java.util.Map}.
     */
    ...
    /**
     * Public setter for the {@link org.springframework.jdbc.core.namedparam.NamedParameterJdbcOperations}.
     * @param namedParameterJdbcTemplate the {@link org.springframework.jdbc.core.namedparam.NamedParameterJdbcOperations} to set
     */
